...
public class V0SearchController
{
    ...
    public SearchRes search(@Valid @RequestParam("data") final String data) {
        ...
        try {
            ...
            V0SearchController.logger.info("X-Real-IP : " + request.getHeader("X-Real-IP"));
            final SearchReq req = new SearchReq();
            req.setData(data);
            V0SearchController.logger.info("====================");
            V0SearchController.logger.info("search : {}");
            res.setData((Object)this.searchService.search(req));
        }
        catch (Exception e) {
            V0SearchController.logger.error("Search", (Throwable)e);
            res.setError();
        }
        return res;
    }
    ...
    static {
        logger = LoggerFactory.getLogger((Class)V0SearchController.class);
    }
}
