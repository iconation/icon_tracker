...
public class TokenEventLog
{
    ...
    public void setTokenEventLog(final TTxResultLog txResultLog) {
        this.txIndex = txResultLog.getTxIndex();
        this.txHash = txResultLog.getTxHash();
        this.contractAddr = txResultLog.getContractAddr();
        this.height = txResultLog.getHeight();
        this.age = txResultLog.getAge();
        this.method = txResultLog.getMethod();
        this.eventLog = txResultLog.getEventLog();
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TokenEventLog)) {
            return false;
        }
        final TokenEventLog other = (TokenEventLog)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TokenEventLog;
    }
    ...
    public String toString() {
        return "TokenEventLog(txIndex=" + this.getTxIndex() + ", txHash=" + this.getTxHash() + ", contractAddr=" + this.getContractAddr() + ", height=" + this.getHeight() + ", age=" + this.getAge() + ", method=" + this.getMethod() + ", eventLog=" + this.getEventLog() + ")";
    }
}
