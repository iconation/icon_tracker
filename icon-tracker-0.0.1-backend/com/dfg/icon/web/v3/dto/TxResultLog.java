...
public class TxResultLog
{
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TxResultLog)) {
            return false;
        }
        final TxResultLog other = (TxResultLog)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TxResultLog;
    }
    ...
    public String toString() {
        return "TxResultLog(txHash=" + this.getTxHash() + ", contractAddr=" + this.getContractAddr() + ", height=" + this.getHeight() + ", txIndex=" + this.getTxIndex() + ", age=" + this.getAge() + ", method=" + this.getMethod() + ", eventLog=" + this.getEventLog() + ")";
    }
}
