...
public class BlockVo
{
    ...
    public List<TransactionVo> getConfrimedTransactionList() {
        return (List<TransactionVo>)this.confrimedTransactionList;
    }
    ...
    public void setConfrimedTransactionList(final List<TransactionVo> confrimedTransactionList) {
