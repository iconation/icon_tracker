...
public class GenesisRpcRes
{
    ...
    public GenesisRpcResult getResult() {
        return this.result;
    }
    ...
    public void setResult(final GenesisRpcResult result) {
        this.result = result;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GenesisRpcRes)) {
            return false;
        }
        final GenesisRpcRes other = (GenesisRpcRes)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GenesisRpcRes;
    }
