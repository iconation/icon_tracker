...
export function* contractListSearchFunc(action) {
    try {
        ...
        yield put({
            type: AT.contractListSearchRejected
        });
    }
}
...
export function* contractInfoFunc(action) {
    try {
        ...
        yield put({
            type: AT.contractInfoRejected,
            error: action.payload.addr
        });
    }
}
...
export function* contractDetailFunc(action) {
    try {
        ...
        if (payload.result === '200' && payload.data !== "NO_DATA") {
            yield put({
                type: AT.contractDetailFulfilled,
                payload
            });
        } else {
            throw new Error();
        ...
        yield put({
            type: AT.contractDetailRejected
        });
    }
}
...
export function* contractTxListFunc(action) {
    try {
        if (action.payload.count === 0) {
            yield put({
                type: AT.contractTxListFulfilled,
                payload: {
                    data: []
                }
            });
        ...
        yield put({
            type: AT.contractTxListRejected
        });
    }
}
...
export function* contractInternalTxListFunc(action) {
    try {
        ...
        yield put({
            type: AT.contractInternalTxListRejected
        });
    }
}
...
export function* contractTokenTxListFunc(action) {
    try {
        ...
        yield put({
            type: AT.contractTokenTxListRejected
        });
    }
}
...
export function* contractEventLogListFunc(action) {
    try {
        ...
        yield put({
            type: AT.contractEventLogListRejected
        });
    }
}
...
export function* icxCallFunc(action) {
    try {
        ...
        yield put({
            type: AT.icxCallFulfilled,
            payload
        })
    } catch (e) {
        yield put({
            type: AT.icxCallRejected
        });
    }
}
...
export function* readContractInformationFunc(action) {
    try {
        ...
        yield put({
            type: AT.readContractInformationFulfilled,
            payload
        })
    } catch (e) {
        yield put({
            type: AT.readContractInformationRejected,
            error: e.message
        })
    }
}