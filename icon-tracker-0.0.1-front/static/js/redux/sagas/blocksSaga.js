...
function* blockInfoFunc(action) {
    try {
        ...
        yield put({
            type: AT.blockInfoRejected,
            error: action.payload.height
        });
    }
}
