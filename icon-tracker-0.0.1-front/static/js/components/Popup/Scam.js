                        ...
                        connectStatus === 2 ? ( <
                            ...
                            Dropzone onDrop = {
                                ...
                                ({
                                    ...
                                    } >
                                    {
                                        dropBoxClass !== '' && ( <
                                            ...
                                            span className = "ellipsis" > {
                                                ...
                                                dropBoxClass === 'error' && < span className = "msg" > {
                                                        msg
                                                    } < /span>} <
                                                    i className = "img"
                                                onClick = {
                                            ...
                                            dropBoxClass === '' && < span > Please drag your file here < /span>} <
                                                ...
                                                input id = "file"
                                            className = "btn-type-normal select" { ...getInputProps()
                                            }
                                            /> <
                                            /Fragment>
                                        )
                                    ...
                                    <
                                    button className = "btn-type-normal"
                                    disabled = {
                                        dropBoxClass === 'error' ? true : false
                                    }
                                    onClick = {
                                        this.handleSubmit
                                    } >
                                    ...
                                    /Fragment>
                                        ...
                                        /p> {
                                            connectStatus === 1 && < p className = "address" > {
                                                    walletAddress
                                                } < /p>} <
                                                div className = "btn-holder" >
                                                <
                                                button className = "btn-type-normal size-half"
                                            onClick = {
                                                    this.onClickNext
                                                } >
                                                <
                                                span > {
                                                    connectStatus === 0 ? 'Connect' : 'Next'
                                                } < /span> <
                                                /button> <
                                                /div> <
                                                /Fragment>
