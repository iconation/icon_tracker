                                ...
                                onClick = {
                                    ...
                                    /span> {
                                        ...
                                        style = {
                                            ...
                                            p className = "txt" > ICON Network의 독자적인 기여도 평가 시스템‘ 위임 기여도 증명 DPoc;
                                        Delegated Proof of Contribution’ 를 기반으로 생태계 기여자 모두를 공정하게 평가하고, 그에 따른 합당한 보상을 분배합니다. < /p> <
                                            div className = "box" >
                                            <
