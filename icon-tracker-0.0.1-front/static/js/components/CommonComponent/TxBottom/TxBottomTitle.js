                ...
                switch (txType) {
                    ...
                    case TX_TYPE.TOKEN_TX:
                        return ( <
                            ...
                            <
                            span >
                            A Total of < em className = "mint"
                            onClick = {
                                goAllTx
                            } > {
                                _listSize
                            }
                            token transfer(s) < /em> found <
                            /span> <
                            /p>
                        )
                    case TX_TYPE.TOKEN_HOLDERS:
                        return ( <
                            p className = "txt" >
                            <
                            span > Top < em className = "mint"
                            onClick = {
                                goAllTx
                            } > {
                                _listSize
                            }
                            Holder(s) < /em><em className="gray">(from a total of {_totalSize} holder(s))</em > < /span> <
                            /p>
                        )
                    ...
                    case TX_TYPE.TRANSACTION_INTERNAL_TX:
                        return ( <
                            p className = "txt" > { <
                                ...
                                label = { < em className = "mint ellipsis" > {
                                        fromAddr
                                    } < /em>} / > To <
                                    AddressLink to = {
                                        toAddr
                                    ...
                                    contract internal transaction(s) <
                                    /p>
                                )
                                default: return ( <
                                    p > < /p>
