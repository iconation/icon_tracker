            ...
            if (loading) {
                ...
                return ( <
                    ...
                    className = {
                        ...
                        td > ICX Value < /td> <
                        td > {
                            convertNumberToText(usdBalance, 3)
                        }
                        USD < /td> <
                        td > Contract Creator < /td> {
                            isCreator && isCreateTx ? ( <
                                ...
                                span className = "link address ellipsis"
                                onMouseOver = {
                                    () => {
                                ...
                                /span> <
                                em > at Txn < /em> <
                                span className = "link hash ellipsis"
                                onMouseOver = {
                                    () => {
                        ...
                        DetailButton contractAddr = {
                            address
                        }
                        contractDetailPopup = {
                            this.props.contractDetailPopup
                        }
                        /> <
                        /td> <
                        /tr> <
