            ...
            TableContents = {
                on => {
                    switch (on) {
                        ...
                        case 1:
                            return ( <
                                ContractInternalTransactions txData = {
                                    contractInternalTx
                                }
                                goAllTx = {
                                    () => {
                                        this.props.history.push(`/${TX_TYPE.CONTRACT_INTERNAL_TX}/${address}`)
                                    }
                                }
                                txType = {
