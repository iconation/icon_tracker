...
const TxHashCell = ({
        ...
        if (!isValidData(txHash)) {
            ...
            _txHash = _is0xHash ? < TransactionLink to = {
                txHash
            }
            ...
            const TokenCell = ({
                ...
                return <td > < span className = "ellipsis" > {
            ...
            const BlockCell = ({
                ...
                return <td className = "on" > < BlockLink to = {
                    height
                }
                label = {
                                ...
                                case TX_TYPE.ADDRESS_DELEGATION:
                                    ...
                                    return ( <
                                        ...
                                        onClick = {
                                            ...
                                            data.grade && < span className = "prep-tag" > {
                                                badgeTitle
                                            } < /span>}{data.name || data.address}</td >
                                            <
                                            td className = "plus" > < span > {
                                            ...
                                            return ( <
                                                ...
                                                case TX_TYPE.CONTRACT_EVENTS:
                                                    return ( <
                                                        ...
                                                        td className = "on" >
                                                        <
                                                        span className = "ellipsis" > < TransactionLink to = {
                                                            data.txHash
                                                        }
                                                        /></span > < br / >
                                                        <
                                                        span > < BlockLink label = {
                                                            `# ${data.height}`
                                                        }
                                                        to = {
                                                            data.height
