            ...
            switch (txType) {
                ...
                case TX_TYPE.CONTRACT_INTERNAL_TX:
                    return ( <
                        ...
                        A total of < em > {
                            _listSize
                        } < /em> internal transaction(s) found <
                        /span> <
                        /p>
                    )
                ...
                case TX_TYPE.TOKEN_HOLDERS:
                    return ( <
                        ...
                        A total of < em > {
                            _totalSize
                        } < /em> holder(s) found<em className="gray">(Showing the top {_listSize} holder(s) only)</em >
                        <
                        /span> <
                        /p>
                    )
                ...
                case TX_TYPE.BLOCKS:
                    return ( <
                        ...
                        A total of < em > {
                            _listSize
                        } < /em> total block(s) found<em className="gray">(Showing the last {_listSize} record(s) only)</em >
                        <
                        /span> <
                        /p>
                    )
                ...
                case TX_TYPE.TRANSACTIONS:
                    return ( <
                        ...
                        A total of < em > {
                            _totalSize
                        } < /em> total transaction(s) found <
                        em className = "gray" > (Showing the last {
                                _listSize
                            }
                            record(s) only) < /em> <
                        /span> <
                ...
                case TX_TYPE.TOKEN_TRANSFERS:
                    return ( <
                        ...
                        A total of < em > {
                            _totalSize
                        } < /em> token transfer(s) found<em className="gray">(Showing the last {_listSize} record(s) only)</em >
                        <
                        /span> <
                        /p>
                    )
