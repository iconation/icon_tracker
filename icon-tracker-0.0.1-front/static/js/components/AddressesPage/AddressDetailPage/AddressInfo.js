...
class AddressInfo extends Component {
    ...
    setPrepData = async address => {
        ...
        const {
            stake,
            unstake
        } = await getStake(address)
        const {
            iscore
        } = await queryIScore(address)
        const {
            totalDelegated
        } = await getDelegation(address)
    ...
    toggleIcxMore = () => {
        this.setState({
            icxMore: !this.state.icxMore
        })
    }

    toggleTokenMore = () => {
        this.setState({
            tokenMore: !this.state.tokenMore
        })
    }
                        ...
                        return ( <
                            ...
                            div className = "wrap-holder" > {
                                isConnected ? ( <
                                    p className = "title" >
                                    My Address {
                                        isPrep && < span className = "title-tag" > {
                                                badge
                                            } < /span>} <
                                    ...
                                    tbody > {
                                        ...
                                        td colSpan = "3" >
                                        <
                                        span > { /* <em>1<sub>st.</sub></em> */ } {
                                            name
                                        } < /span> {
                                            website && < span className = "home"
                                            onClick = {
                                                () => {
                                            ...
                                            facebook && < span className = "facebook"
                                            onClick = {
                                                () => {
                                            ...
                                            keybase && < span className = "keybase"
                                            onClick = {
                                                () => {
                                                    window.open(keybase, '_blank')
                                                }
                                            } > < i className = "img" > < /i></span >
                                        } {
                                            reddit && < span className = "reddit"
                                            onClick = {
                                                () => {
                                            ...
                                            steemit && < span className = "steemit"
                                            onClick = {
                                                () => {
                                                    window.open(steemit, '_blank')
                                                }
                                            } > < i className = "img" > < /i></span >
                                        } {
                                            telegram && < span className = "telegram"
                                            onClick = {
                                                () => {
                                            ...
                                            twitter && < span className = "twitter"
                                            onClick = {
                                                () => {
                                            ...
                                            wechat && < span className = "wechat"
                                            onClick = {
                                                () => {
                                                    window.open(wechat, 'wechat')
                                                }
                                            } > < i className = "img" > < /i></span >
                                        } {
                                            youtube && < span className = "youtube"
                                            onClick = {
                                                () => {
                                        ...
                                        span className = {
                                            `active ${this.state.active === 'Active' ? 'on' : 'off'}`
                                        } > < i > < /i>{this.state.active}</span > { /* <span className="btn-scam">Go to Voting</span> */ } <
                                        /td> <
                                        /tr>} {
                                            isPrep && < tr className = "" >
                                                <
                                                ...
                                                /tr>} {
                                                    isPrep && < tr className = "last" >
                                                        ...
                                                        td > < span > {
                                                            ...
                                                            / {numberWithCommas(produced)} )</em > < /span></td >
                                                            <
                                                            td > Last Blockheight < /td> {
                                                                ...
                                                                } { /* <em className="small">( 2019-01-01 17:03:35 )</em> */ } < /span></td >
                                                            } <
                                                            /tr>} {
                                                                isPrep && < tr className = "governance" >
                                                                    ...
                                                                    td colSpan = "3" >
                                                                    <
                                                                    span > < i > i < sub > rep < /sub></i > {
                                                                        numberWithCommas(_irep)
                                                                    } < /span> <
                                                                ...
                                                                className = {
                                                                        ...
                                                                        isSpan / > {
                                                                            isValidNodeType(nodeType) && < span className = "crep" > {
                                                                                `${nodeType}`
                                                                            } < /span>} <
                                                                            ReportButton address = {
                                                                                address
                                                                            }
                                                                            /> <
                                                                            /td> <
                                                                            ...
                                                                            <
                                                                            div className = {
                                                                                this.state.icxMore ? 'on' : ''
                                                                            } >
                                                                            <
                                                                            p > < span > < i className = "coin icon" > < /i>ICX</span > < span > {
                                                                                `${convertNumberToText(this.state.balance, 4)}`
                                                                            } < em > ICX < /em></span > < em className = "drop-btn"
                                                                            onClick = {
                                                                                this.toggleIcxMore
                                                                            } > < i className = "img" > < /i></em > < /p> <
                                                                            p > < span > Available < /span><span>{`${convertNumberToText(this.state.available)}`}<em>ICX</em > < /span></p >
                                                                            <
                                                                            p > < span > Staked < /span><span><em>{(!Number(this.state.balance) ? 0 : Number(this.state.staked) /
                                                                            Number(this.state.balance) * 100).toFixed(2)
                                                                    } % < /em>{`${convertNumberToText(this.state.staked)}`}<em>ICX</em > < /span></p >
                                                                    <
                                                                    p > < span > Unstaking < /span><span><em>{(!Number(this.state.balance) ? 0 : Number(this.state.unstaked) /
                                                                Number(this.state.balance) * 100).toFixed(2)
                                                        } % < /em>{`${convertNumberToText(this.state.unstaked)}`}<em>ICX</em > < /span></p >
                                                        <
                                                        p > < span > Voted < /span><span><em>{(!Number(this.state.staked) ? 0 : Number(this.state.delegated) /
                                                    Number(this.state.staked) * 100).toFixed(2)
                                        } % < /em>{`${convertNumberToText(this.state.delegated)}`}<em>ICX</em > < /span></p >
                                        <
                                        p > < span > I_SCORE < /span><span>{`${convertNumberToText(this.state.iscore)}`}<em>I-Score</em > < /span></p >
                                        <
                                        /div> <
                                        div className = {
                                            this.state.tokenMore ? 'on' : ''
                                        } >
                                        <
                                        p > < span > < i className = "coin" > < /i>Token</span > < span > {
                                            (tokenList || []).length
                                        } < em > Tokens < /em></span > < em className = "drop-btn"
                                        onClick = {
                                            this.toggleTokenMore
                                        } > < i className = "img" > < /i></em > < /p> {
                                            (tokenList || []).map((token, index) => {
                                                ...
                                                return <p key = {
                                                    ...
                                                    contractName
                                                } < /span><span>{`${convertNumberToText(quantity)}`}<em>{contractSymbol}</em > < /span></p >
                                            })
                                        } <
                                        /div> <
                                        /td> <
                                ...
                                if (_tokenList.length === 0) {
                                    ...
                                    return ( <
                                        ...
                                        onClick = {
                                            ...
                                            convertNumberToText(totalBalance, 3)
                                        }
                                        USD < span className = "gray" > (Total) < /span> <
                                        em className = "img" / >
                                        <
                                        /p> <
                                                ...
                                                ul className = "list-group" > {
                                                    list.map((token, index) => {
                                                        ...
                                                        return ( <
                                                            ...
                                                            em > {
                                                                totalTokenPrice ? convertNumberToText(totalTokenPrice, 3) : '-'
                                                            } < /em> <
                                                            em > USD < /em> <
                                                            /p> <
                                                            p >
                                                            ...
                                                            /em> <
                                                            em > {
                                                                tokenPrice ? convertNumberToText(tokenPrice, 3) : '-'
                                                            } < /em> <
                                                            em > @ < /em> <
                                                            /p> <
                                                            /li>
