            ...
            TableContents = {
                on => {
                    switch (TABS[on]) {
                        ...
                        case ADDRESS_TABS[1]:
                            return ( <
                                AddressInternalTransactions txData = {
                                    addressInternalTx
                                }
                                goAllTx = {
                                    () => {
                                        this.props.history.push(`/${TX_TYPE.ADDRESS_INTERNAL_TX}/${address}`)
                                    }
                                }
                                txType = {
