...
class AddressesDetailPage extends Component {
    ...
    render() {
        ...
        if (internalTxCount && Number(internalTxCount) !== 0) {
            ...
            getList.push(address => {
                this.props.addressInternalTxList({
                    address,
                    page: 1,
                    count: 10
                })
        ...
        if (hasDelegations) {
            ...
            getList.push(address => {
                this.props.addressDelegationList({
                    address
                })
            })
        }
