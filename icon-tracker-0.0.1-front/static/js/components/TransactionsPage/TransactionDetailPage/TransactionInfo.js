            ...
            if (loading) {
                ...
                return ( <
                    ...
                    td className = {
                        ...
                        span className = "copy twit"
                        onClick = {
                            this.onTwitterClick
                        } > { /* <i className="img twit-icon"></i> */ } <
                        img className = 'custom-twitter'
                        src = {
                            twitterLogo
                        }
                        /> <
                        ...
                        td className = {
                            ...
                            (isFail && isErrorMsg) && `- ${errorMsg}`
                        } < /td> <
                        /tr> <
                        tr >
                        <
                        td > Block Height < /td> <
                        td > < span > < BlockLink to = {
                            height
                        }
                        label = {
                        ...
                        /></span > < em > {
                            `(${confirmation ? numberWithCommas(confirmation) : ' -'} Confirmation(s))`
                        } < /em></td >
                        <
                        /tr> <
                        tr >
                        ...
                        td > Step Price < /td> <
                        td > {
                            convertNumberToText(stepPriceIcx)
                        }
                        ICX < em > ({
                        ...
                        ICX < em > ({
                                feeUsd ? convertNumberToText(feeUsd, 4) : ' -'
                            }
                            USD) < /em></td >
                        <
                        /tr> {
    ...
    class DataCell extends Component {
        ...
        getDataString = () => {
            ...
            try {
                if (dataType === 'message') {
                    ...
                    this.setState({
                        converted: beautifyJson(dataString, '\t')
                    })
                }
            } catch (error) {
                console.error(error)
        ...
        render() {
            ...
            return ( <
                ...
                <
                div className = "scroll" > {!viewHex && _isImageData ?
                    <
                    img src = {
                        converted
                    }
                ...
                /div> {
                    isButton && < button className = "btn-type-normal"
                    onClick = {
                        this.handleClick
                    }
                    disabled = {
                            ...
                            td className = "transfer" > {
                                tokenTxListSliced.map((tokenTx, index) => {
                                        ...
                                        return ( <
                                            ...
                                            emsp; from & emsp; < AddressLink to = {
                                                fromAddr
                                            }
                                            label = { < span className = "ellipsis" > {
                                                    fromAddr
                                                } < /span>} / >
                                                &
                                                emsp;to & emsp; < AddressLink to = {
                                                    toAddr
                                                }
                                                label = { < span className = "ellipsis" > {
                                                        toAddr
                                        ...
                                        div > {
                                            internalTxListSliced.map((tx, index) => {
                                                ...
                                                return ( <
                                                    ...
                                                    ICX &
                                                    emsp; from & emsp; < span > < AddressLink to = {
                                                        fromAddr
                                                    }
                                                    /></span >
                                                    &
                                                    emsp; to & emsp; < span > < AddressLink to = {
                                                        toAddr
                                                    }
                                                    /></span >
                                                    <
                                ...
                                const AddressRow = ({
                                        ...
                                        if (isAddress) {
                                            return ( <
                                                ...
                                                spanNoEllipsis tdClassName = "trans"
                                                isFrom = {
                                                    isFrom
                                                }
                                                download = {
                                                ...
                                                InternalDiv = {
                                                    (internalTxList && internalTxList.length !== 0) && < InternalTx internalTxList = {
                                                        internalTxList
                                                    }
                                                    />} /
                                                    >
