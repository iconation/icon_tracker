...
class GovernancePage extends Component {
    ...
    async componentDidMount() {
        ...
        const {
            preps,
            totalStake: totalStakedLoop,
            totalDelegated: totalVotedLoop
        } = await getPReps()
        const {
            variable
        } = await getIISSInfo()
        ...
        return ( <
                ...
                div className = "screen0" > {
                    ...
                    !loading && < div className = "wrap-holder" >
                        <
                        p className = "title" > Governance < span onClick = {
                            () => {
                                this.props.setPopup({
                                    type: POPUP_TYPE.ABOUT
                                })
                            }
                        } > < i className = "img" > < /i>About Governance</span > < /p> <
                    ...
                    style = {
                        ...
                        } > < span > 100 < em > % < /em></span > < /div> <
                        div className = {
                            `bar${totalStakedRate - totalVotedRate < 11 ? ' small' : ''}`
                        }
                    style = {
                            {
                                width: `${totalStakedRate}%`
                            }
                        } > {
                            totalStakedRate > 8 && < span > {
                    ...
                    style = {
                            {
                                width: `${totalVotedRate}%`
                            }
                        } > {
                            totalVotedRate > 8 && < span > {
                        ...
                        p > r < sub > rep < /sub> * 3</p >
                        <
                        p > < em > % < /em><span>{convertNumberToText(rrep /
                    100 * 3, 4)
            } < /span></p >
            <
            /li> {
            ...
            p > Last Block {
                lastBlockPrepName && < span > {
                    ...
                    div className = "screen2" > {
                        ...
                        /> <
                        label htmlFor = "cbox-01"
                        className = "label _img" > Main P - Rep({
                                allPrep.filter(p => p.grade === 0).length
                            }) < /label> <
                            /span>						 <
                            span >
                            <
                        ...
                        className = "label _img" > Sub P - Rep({
                                allPrep.filter(p => p.grade === 1).length
                            }) < /label> <
                            /span>						 <
                            span >
                            <
                        ...
                        /> <
                        label htmlFor = "cbox-03"
                        className = "label _img" > P - Rep({
                                allPrep.filter(p => p.grade === 2).length
                            }) < /label> <
                            /span> <
                        ...
                        /> <
                        label htmlFor = "cbox-04"
                        className = "label _img" > Blacklist({
                                blackPrep.length
                            }) < /label>									 <
                            /span> <
                            span className = "search on" > < input type = "text"
                        ...
                        div className = "table-box" >
                            ...
                            <
                            th rowSpan = "2"
                        className = "add" > Add < /th> <
                            th rowSpan = "2"
                        className = "rank" > < span className = "sort" > Rank↓ < /span></th >
                            <
                            ...
                            The detailed informations of P - Rep will be updated every UTC 00: 00, UTC 06: 00, UTC 12: 00, and UTC 18: 00. Please check the URL of the submitted JSON file
                        for each P - Rep. <
                            /p> <
                            /div> <
                            /div>} <
    ...
    class TableRow extends Component {
        ...
        render() {
            ...
            return ( <
                ...
                li >
                <
                span className = "ellipsis pointer"
                onClick = {
                    () => {
                ...
                td > < span > {
                    productivity
                } < /span><em>{numberWithCommas(validatedBlocks)} / {
                    numberWithCommas(totalBlocks)
                } < /em></td >
                <
                td > < span > {
                    numberWithCommas(IconConverter.toNumber(irep || 0))
                } < /span></td >
                <
                td > < span > {
                    numberWithCommas(IconConverter.toNumber(irepUpdatedBlockHeight))
                } < /span></td >
                <
                td > < span > {
                    stakedRate.toFixed(1)
                } % < /span><em>{convertNumberToText(prepStaked, 4)}</em > < /td> <
                td > < span > {
                    votedRate.toFixed(1)
                } % < /span><em>{convertNumberToText(prepVoted, 4)}</em > < /td> <
                /tr>
            )
        }
    }
